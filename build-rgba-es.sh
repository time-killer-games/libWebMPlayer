...
if [ $(uname) = "Darwin" ]; then
  ...
  clang++ audio_decoder.cpp frame_buffer.cpp lodepng.cpp timer.cpp file_reader.cpp libwebmplayer.cpp gamemaker.cpp packet.cpp utils.cpp frame.cpp player.cpp video_player.cpp webm_player.cpp libwebm.a /opt/local/lib/libogg.a /opt/local/lib/libvorbis.a /opt/local/lib/libvorbisenc.a /opt/local/lib/libvorbisfile.a /opt/local/lib/libvpx.a /opt/local/lib/libz.a /opt/local/lib/libSDL2.a -liconv -I$HOME/ -I$HOME/webm -I../include/ -o ../libWebMPlayer.dylib -std=c++17 -shared -I/opt/local/include -lm -Wl,-framework,CoreAudio -Wl,-framework,AudioToolbox -Wl,-weak_framework,CoreHaptics -Wl,-weak_framework,GameController -Wl,-framework,ForceFeedback -lobjc -Wl,-framework,CoreVideo -Wl,-framework,Cocoa -Wl,-framework,Carbon -Wl,-framework,IOKit -Wl,-weak_framework,QuartzCore -Wl,-weak_framework,Metal -Wno-narrowing -arch arm64 -arch x86_64 -fPIC
